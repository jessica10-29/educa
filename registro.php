    ...
    <div class="login-container">
        ...
        <div class="glass-panel login-box fade-in" style="max-width: 480px;">
            <div class="logo-area" style="margin-bottom: 25px;">
                ...
                <h2 style="font-size: 1.8rem;">Únete a Unicali</h2>
            ...
            <form method="POST" action="">
                ...
                <div id="codigo-area" class="input-group" style="display: none; border: 1px border-dashed var(--warning); padding: 15px; border-radius: 12px; background: rgba(245, 158, 11, 0.05);">
                    <label class="input-label" style="color: var(--warning);">Código Docente</label>
                    <input type="password" name="codigo_docente" class="input-field" placeholder="Secret Key">
                </div>

                <div class="input-group">
                    <label class="input-label">Contraseña</label>
                    <div class="input-wrapper">
                        <input type="password" name="password" id="password" class="input-field" placeholder="Mínimo 8 caracteres" required>
