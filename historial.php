    ...
    <div class="dashboard-grid">
        ...
        <main class="main-content">
            <header style="margin-bottom: 30px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 20px;">
                <div>
                    <h1 class="text-gradient">Certificado de Calificaciones</h1>
                    <p class="text-muted">Desempeño general basado en sistema de 5 cortes</p>
                </div>
                <a href="pdf.php" target="_blank" class="btn btn-primary">
                    <i class="fa-solid fa-file-pdf"></i> Generar Certificado
                </a>
            </header>
