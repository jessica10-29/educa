...
$sql = "SELECT id, nombre, codigo, descripcion, (SELECT COUNT(*) FROM matriculas WHERE materia_id = materias.id) as alumnos_cuenta FROM materias WHERE profesor_id = $profesor_id";
